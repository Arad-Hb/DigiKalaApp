...
const ProductDetails = ({data}) => {
  ...
  return (
    <div className={`${styles.outerContainer}`}>
        ...
        <div className={`${styles.priceContainer}`}><ProductPrice data={data} key="ProductPrice"/></div>
        <div className={`${styles.descriptionContainer}`}>
          ...
          <span className={`${styles.descriptionComponent}`}><ProductDescription data={data} key="ProductDescription"/></span>
        </div>
    </div>
  )
}
