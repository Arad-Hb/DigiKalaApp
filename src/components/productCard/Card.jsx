  ...
  return (
    ...
    <div className={`${styles.cardContainer}`}>
        <div className={`${styles.header}`}>
          ...
          <NavLink url={`/products/singleProduct/${product.id}`} key={GetID()}><Image src={product.indexImageUrl} alt={product.name} width={150} height={170}  className={`${styles.image}`}/></NavLink>
        </div>
